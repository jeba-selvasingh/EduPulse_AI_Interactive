...
import { MockTestSchedulePanel } from '@/src/components/MockTestSchedulePanel';
...
export default function MockTestScheduleScreen() {
  const router = useRouter();
  const allowed = usePermission(Permission.CampusDriveRead);

  if (!allowed) {
    return <AccessDenied featureName="Mock test schedule" />;
  }
