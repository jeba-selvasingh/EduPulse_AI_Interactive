...
import { NaacPredictionPanel } from '@/src/components/NaacPredictionPanel';
...
export default function NaacPredictionScreen() {
  const router = useRouter();
  const allowed = usePermission(Permission.CollegeRadarRead);

  if (!allowed) {
    return <AccessDenied featureName="NAAC Prediction" />;
  }
