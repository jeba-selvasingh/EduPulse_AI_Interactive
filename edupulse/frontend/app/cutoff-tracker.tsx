...
import { CutoffTrackerPanel } from '@/src/components/CutoffTrackerPanel';
...
export default function CutoffTrackerScreen() {
  const router = useRouter();
  const allowed = usePermission(Permission.CollegeRadarRead);

  if (!allowed) {
    return <AccessDenied featureName="Cutoff Tracker" />;
  }
