...
import { InstitutionPulsePanel } from '@/src/components/InstitutionPulsePanel';
...
export default function DeanPulseScreen() {
  const router = useRouter();
  const allowed = usePermission(Permission.DeanPulseRead);

  if (!allowed) {
    return <AccessDenied featureName="Dean Pulse" />;
  }
